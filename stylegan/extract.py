...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default='pretrained/stylegan2-church-config-f.pkl')
    ...
    torch.save(w_lst, f'/media/exx/8TB1/ewang/tensor/W{dataset_name}.pt')
    ...
    torch.save(sample_s, f'/media/exx/8TB1/ewang/tensor/S{dataset_name}.pt')
    del sample_s
    ...
    torch.save(s_mean, f'/media/exx/8TB1/ewang/tensor/S_mean{dataset_name}.pt')
    torch.save(s_std, f'/media/exx/8TB1/ewang/tensor/S_std{dataset_name}.pt')
    print("Done.")
