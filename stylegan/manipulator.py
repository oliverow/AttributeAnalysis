...
class Manipulator():
    ...
    *** Attributes ***
    ...
    def __init__(
        ...
        self.W = torch.load(f'/media/exx/8TB1/ewang/tensor/W{dataset_name}.pt')
        self.S = torch.load(f'/media/exx/8TB1/ewang/tensor/S{dataset_name}.pt')
        self.S_mean = torch.load(f'/media/exx/8TB1/ewang/tensor/S_mean{dataset_name}.pt')
        self.S_std = torch.load(f'/media/exx/8TB1/ewang/tensor/S_std{dataset_name}.pt')
...
def extract_global_direction(G, device, lst_alpha, num_images, dataset_name=''):
    ...
    np.save(f'/media/exx/8TB1/ewang/tensor/fs3{dataset_name}.npy', fs3) # global style direction
...
if __name__ == '__main__':
    ...
    elif runtype == 'extract': # extract global style direction from "/media/exx/8TB1/ewang/tensor/S.pt"
        num_images = 100
        lst_alpha = [-5, 5]
